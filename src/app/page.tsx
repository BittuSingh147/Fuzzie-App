          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center flex-col w-full">
                ...
                >
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-neutral-500 to-neutral-600 text-center font-sans group-hover:bg-gradient-to-r group-hover:from-black group-hover:to-black whitespace-normal">
